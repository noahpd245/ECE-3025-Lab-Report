...
We used a range of exponents ranging from 0 to 100 with a 0.1 step size and found the best fit exponent to be 33.1 with a normalized error of 0.0077. Figure %%REFERENCE%% shows our measured data with our raised cosine approximation.
